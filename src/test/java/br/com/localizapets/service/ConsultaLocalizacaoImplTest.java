...
//
//
//    LocalizacaoPortIn localizacaoPortIn;
//    LocationApiPetImpl consultaLocalizacaoImpl;
//
//    @BeforeEach
//    public void setup(){
//        localizacaoPortIn = mock(LocalizacaoPortIn.class);
//        consultaLocalizacaoImpl = new LocationApiPetImpl();
//    }
//
//    @Test
...
//        when(localizacaoPortIn.consultar(anyString(),anyString(),anyString(),anyString(),anyString())).thenReturn(LocationMock.getErrorLat());
//    }
}
